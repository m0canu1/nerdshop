...
jQuery(document).ready(function (){
  ...
  function setInfo(nodecontainer, obj, i) {
    ...
    var nodeinfo = document.createElement('div'); //cart_info
  ...
  function setFirstForm(nodeorder, obj, i) {
    var node = document.createElement('h3'); // prezzo del prodotto
    ...
    nodeform.appendChild(nodeinput);
    var nodewish = document.createElement('button'); // button del form
  ...
  function setSecondForm(nodeorder, obj, i) {
    var nodesecondform = document.createElement('form'); // creazione del form
    ...
    nodeinput.id = 'user';
    nodesecondform.appendChild(nodeinput);
    var noderemove = document.createElement('button'); // button del form
    ...
    if(obj[i][2] > 0){
      var nodethirdform = document.createElement('form'); // creazione del form
      nodediv.appendChild(nodethirdform);
      nodethirdform.setAttribute('action', '../view/buy.php?prod='+obj[i][1]);
      nodethirdform.setAttribute('method', 'POST');
      var nodeselect = document.createElement('select'); // select del form
      ...
      var nodebuy = document.createElement('button'); // button del form
    ...
    var nodeh = document.createElement('hr');
