<!--
  ...
  In questa pagina vengono mostrati i prodotti in vendita.
  Qui è possibile:
  - visualizzare il catalogo del sito;
  - selezionare un prodotto per ottenere ulteriori informazioni;
  - effettuare una ricerca;
  - aggiungere uno o più prodotti nel carrello e nella Wishlist.
-->
<?php
  include("top.html");
